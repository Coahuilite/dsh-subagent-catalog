	...
	factory: (require) => {
		...
		*/
		...
		const STYLES = [
			...
			".dsc-picker{position:absolute;z-index:2;top:calc(100% + 4px);left:0;display:flex;flex-direction:column;gap:2px;min-width:190px;padding:4px;border:1px solid var(--dsw-alias-border-l1);border-radius:10px;background:var(--dsw-specific-menu);backdrop-filter:var(--dsw-menu-backdrop-filter);box-shadow:var(--dsw-elevation-prominent);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1)}",
			...
			return {
				...
				apply: (0, react.useCallback)(async (selection) => {
					...
					setCurrent((previous) => ({
						...previous,
						busy: false,
						note: selection.provider + "/" + selection.model
					}));
					await load();
				}, [
					parentSessionId,
		...
		*/
		function ModelEntry({ row, t }) {
			...
			const blocked = current.state !== void 0 && current.state.allowed === null;
			const notLive = current.state !== void 0 && current.state.allowed !== null && !current.state.live;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					notLive && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsc-pickerNote",
						children: t("edit.notLive")
					}),
					current.note !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsc-pickerOk",
						children: t("edit.applied")
					}),
					routes?.map((route) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
		...
		function EffortEntry({ row, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					loaded && efforts.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsc-pickerNote",
						children: t("pick.none")
					}),
					efforts.map((effort) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "dsc-pickerOption",
						disabled: current.busy,
