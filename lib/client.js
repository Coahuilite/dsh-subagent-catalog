	...
	factory: (require) => {
		...
		*/
		...
		const STYLES = [
			...
			".dsc-editorBar{display:flex;padding:2px 4px 4px}",
			".dsc-editorOpen{font:inherit;font-size:12px;line-height:18px;padding:3px 10px;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary);cursor:pointer}",
			".dsc-editorOpen:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}",
			".dsc-editorOpen:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}",
			".dsc-editor{display:flex;flex-direction:column;gap:6px;margin:2px 4px 4px;padding:10px;border:1px solid var(--dsw-alias-border-l2);border-radius:14px}",
			".dsc-editorHead{display:flex;align-items:baseline;gap:8px}",
			".dsc-editorTitle{flex:1;font-size:12px;line-height:18px;font-weight:600;color:var(--dsw-alias-label-secondary)}",
			".dsc-editorClose{font:inherit;font-size:11px;line-height:16px;padding:2px 8px;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:transparent;color:var(--dsw-alias-label-tertiary);cursor:pointer}",
			".dsc-editorField{display:flex;flex-direction:column;gap:3px}",
			".dsc-editorLabel{font-size:11px;line-height:16px;color:var(--dsw-alias-label-caption)}",
			".dsc-editorSelect{font:inherit;font-size:12px;line-height:18px;box-sizing:border-box;width:100%;padding:4px 6px;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}",
			".dsc-editorSelect:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}",
			".dsc-editorPreview{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums}",
			".dsc-editorNote{margin:0;font-size:11px;line-height:16px;color:var(--dsw-alias-label-tertiary)}",
			".dsc-editorError{margin:0;font-size:11px;line-height:16px;color:var(--dsw-alias-state-error-primary)}",
			".dsc-editorOk{margin:0;font-size:11px;line-height:16px;color:var(--dsw-alias-state-success-primary)}",
			".dsc-editorApply{font:inherit;font-size:12px;line-height:18px;align-self:flex-start;padding:4px 12px;border:1px solid transparent;border-radius:8px;background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground);cursor:pointer}",
			".dsc-editorApply:disabled{cursor:default;opacity:.5}",
			".dsc-editorApply:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}"
		].join("");
		/**
		...
		*/
		...
		function sameRoute$1(left, right) {
		...
		*/
		function modelOf(summary) {
			...
			return {
				...route,
				state: sameRoute$1(lastUsed, next) ? "used" : "next"
			};
		}
		/**
		...
		*/
		async function applyRetarget(parentSessionId, childSessionId, selection) {
			...
			const selected = routeReadingOf((typeof body === "object" && body !== null ? body : {}).selected);
		...
		//#endregion
		//#region src/client/RetargetEditor.tsx
		/**
		...
		*/
		function sameRoute(reading, provider, model) {
		...
		*/
		function RetargetEditor({ rows, parentSessionId, t }) {
			const [open, setOpen] = (0, react.useState)(false);
			const [targetId, setTargetId] = (0, react.useState)(() => String(rows[0]?.id ?? ""));
			const [state, setState] = (0, react.useState)();
			const [reading, setReading] = (0, react.useState)(true);
			const [readError, setReadError] = (0, react.useState)();
			...
			const allowed = state?.allowed ?? void 0;
			/** Load the target's state and seed the form from its current route. */
			const load = (0, react.useCallback)(async (childSessionId) => {
				...
				const seeded = routes.find((route) => current !== null && route.provider === current.provider && route.model === current.model) ?? routes[0];
				setProvider(seeded?.provider ?? "");
				setModel(seeded?.model ?? "");
				setEffort(current !== null && seeded !== void 0 && current.provider === seeded.provider && current.model === seeded.model ? current.reasoningEffort ?? "" : "");
			}, [parentSessionId]);
			(0, react.useEffect)(() => {
				if (rows.length === 0) {
					setOpen(false);
			...
			const efforts = effortsOf((allowed ?? []).find((route) => route.provider === provider && route.model === model));
			const routeChanged = !sameRoute(state?.current ?? null, provider, model);
			const effectiveEffort = effort === "" ? void 0 : effort;
			const shownEffort = effectiveEffort ?? (routeChanged ? t("edit.effort.default") : state?.current?.reasoningEffort ?? t("edit.effort.default"));
			const preview = provider === "" || model === "" ? "—" : provider + "/" + model + " · " + shownEffort;
			const submit = async () => {
			...
			if (!open) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dsc-editorBar",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					className: "dsc-editorOpen",
					onClick: () => {
						setOpen(true);
					},
					children: t("edit.open")
				})
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dsc-editor",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsc-editorHead",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dsc-editorTitle",
							children: t("edit.title")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dsc-editorClose",
							onClick: () => {
								setOpen(false);
							},
							children: t("edit.close")
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						className: "dsc-editorField",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dsc-editorLabel",
							children: t("edit.target")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
							className: "dsc-editorSelect",
							value: targetId,
							onChange: (event) => {
							...
							children: rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: String(row.id),
								children: targetLabel(row)
							}, String(row.id)))
						})]
					}),
					reading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "dsc-editorNote",
						children: t("edit.loading")
					}),
					readError !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "dsc-editorError",
						children: readError
					}),
					!reading && readError === void 0 && state !== void 0 && (state.allowed === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "dsc-editorNote",
						children: t("edit.noPolicy")
					}) : !state.live ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "dsc-editorNote",
						children: t("edit.notLive")
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							className: "dsc-editorField",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dsc-editorLabel",
								children: t("edit.provider")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
								className: "dsc-editorSelect",
								value: provider,
								onChange: (event) => {
								...
								children: providers.map((id) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: id,
									children: id
								}, id))
							})]
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: "—"
								}), modelsForProvider.map((route) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: route.model,
						...
						efforts.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: t("edit.effort.default")
								}), efforts.map((id) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: id,
									children: id
								}, id))]
							})]
					...
					outcome !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: outcome.ok ? "dsc-editorOk" : "dsc-editorError",
		...
		function SubagentCatalogAction({ sessionId, useSessions, openSubagent, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RetargetEditor, {
						rows,
